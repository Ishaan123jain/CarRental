    ...
    <body>
        ...
        <div>
            ...
            <form action="/book" method="post">
                ...
                <label>Address</label>
                <input type="text" name="address" placeholder="User address.."><br>

                <label>Age</label>
                <input type="text" name="age" placeholder=""><br>

                <label>No. of days</label>
                <input type="number" min="1" max="100" name="days"><br>
...
@routers.post("/book", response_class=HTMLResponse)
async def book(name: str = Form(...), address: str = Form(...), age: str = Form(...), days: int = Form(...),  db:Session = Depends(get_db)):

    User_new = models.Booking(name = name, address=address, age=age, days=days, date=date.today())
    db.add(User_new)
    db.commit()
    db.refresh(User_new)
    ...
    return HTMLResponse(f"""
    <script>
        alert("Booking Successful for {name}, {days} days.");
